        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Tugas Menunggu Persetujuan</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
...
$query = "select *from tugas WHERE `Status`='Menunggu Persetujuan' and `Penanggungjawab`='".$_SESSION['Jabatan']."' and `KodeDesa`='".$_SESSION['KodeDesa']."' order by TanggalAkhir ASC"; // Tampilkan semua data tugas
...
?>
    ...
    <tbody>
        ...
        <td  width=16% align="center"><a class="pilihan" href='UbahTugas.php?Id=<?php echo $data['Id']; ?>'> <img src="images/Ikon_ubah.png"> Ubah</a> |  <a class="pilihan" href="HapusData.php ?Id=<?php echo $data['Id'] ?>"><img src="images/Ikon_hapus.png"> Hapus</a> </td>
      </tr>
