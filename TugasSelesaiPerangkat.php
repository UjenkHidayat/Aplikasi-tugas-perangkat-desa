...
$query = "select *from tugas WHERE `Status`='Selesai' and `Penanggungjawab`='".$_SESSION['Jabatan']."' and `KodeDesa`='".$_SESSION['KodeDesa']."' order by TanggalAkhir ASC"; // Tampilkan semua data tugas
