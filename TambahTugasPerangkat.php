...
$QueryInput = mysqli_query($connection," Insert Into `tugas` (`Id`, `UraianTugas`, `TanggalAkhir`, `Penanggungjawab`, `Status`,`KodeDesa`) VALUES (NULL, '$Uraian','$TanggalAkhir','".$_SESSION['Jabatan']."', 'Menunggu Persetujuan','".$_SESSION['KodeDesa']."')" );




 if(QueryInput){
 header("location:TugasBelumDisetujui.php"); // Redirectke halaman index.php
  echo $Uraian;
 }
else{
