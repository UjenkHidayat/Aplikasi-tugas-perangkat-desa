        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Permintaan Tugas</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
...
$query = "select *from tugas WHERE `Status`='Menunggu Persetujuan' and `KodeDesa`='".$_SESSION['KodeDesa']."' order by TanggalAkhir ASC"; // Tampilkan semua data tugas
...
?>
    ...
    <tbody>
        ...
        <td  width=16% align="center"> <a class="pilihan" href='SetujuiTugas.php?Id=<?php echo $data['Id']; ?>'> <i class="fas fa-file-signature alt"></i> Setujui Tugas</a>  </td>
      </tr>
