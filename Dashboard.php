        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="PermintaanTugas.php"><i class="fas fa-edit"></i><span>Permintaan Tugas</span></a></li>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"> <?php echo $_SESSION['Username'];?></span><i class="fas fa-user-circle"></i></a>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            $TugasBelum = "select count(UraianTugas) as `Jumlah`from `tugas` where `Status`='Belum Selesai' "; // Tampilkan semua data tugas
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                            // $query = "select Id,Bulan, sum(Pendapatan) as total from coba group by Bulan order by Id Asc";
                                            $TugasSelesai = "select count(UraianTugas) as `Jumlah`from `tugas` where `Status`='Selesai' "; // Tampilkan semua data tugas
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span>tugas terlewatkan</span></div>
                                              ...
                                              <?php
                                            // $query = "select Id,Bulan, sum(Pendapatan) as total from coba group by Bulan order by Id Asc";
                                            $TugasTerlewat = "select count(UraianTugas) as `Jumlah`from `tugas` where `TanggalAkhir` < curdate() and status ='Belum Selesai' "; // Tampilkan semua data tugas
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                            // $query = "select Id,Bulan, sum(Pendapatan) as total from coba group by Bulan order by Id Asc";
                                            $TugasTotal = "select count(UraianTugas) as `Jumlah`from `tugas`"; // Tampilkan semua data tugas
                        ...
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="chart-area"><canvas data-bss-chart="{&quot;type&quot;:&quot;bar&quot;,&quot;data&quot;:{&quot;labels&quot;:[&quot;Sekdes&quot;,&quot;Kaur Keuangan&quot;,&quot;Kaur Renca&quot;,&quot;Kaur Umum&quot;,&quot;Kasi Pem&quot;,&quot;Kasi Pelayanan&quot;,&quot;Kasi Kesra&quot;,&quot;Kadus&quot;],&quot;datasets&quot;:[{&quot;label&quot;:&quot;Jumlah Tugas&quot;,&quot;backgroundColor&quot;:&quot;rgb(144,159,238)&quot;,&quot;borderColor&quot;:&quot;rgba(78, 115, 223, 1)&quot;,&quot;data&quot;:
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                   <?php 
                                    ...
                                    $query = "select *from tugas WHERE `Status`='Belum Selesai' and `TanggalAkhir` between curdate() and curdate()+7 order by TanggalAkhir ASC "; // Tampilkan semua data tugas
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                   <?php 
                                    ...
                                    $query = "select *from tugas WHERE `Status`='Belum Selesai' and `TanggalAkhir` < curdate() order by TanggalAkhir ASC "; // Tampilkan semua data tugas
                                    $sql = mysqli_query($connection, $query); // Eksekusi/Jalankan query dari variabel $query
                                    $row = mysqli_num_rows($sql); // Ambil jumlah data dari hasil eksekusi $sql
                                    ?>
