...
$query = "select *from tugas WHERE `Status`='Belum Selesai' and `UraianTugas` Like '%$Uraian%' order by TanggalAkhir ASC"; // Tampilkan semua data tugas
}
...
// $query = "select Id,Bulan, sum(Pendapatan) as total from coba group by Bulan order by Id Asc";
$query = "select *from tugas WHERE `Status`='Belum Selesai' and `KodeDesa`='".$_SESSION['KodeDesa']."' order by TanggalAkhir ASC"; // Tampilkan semua data tugas
}
...
?>
    ...
    <tbody>
        ...
        <td  width=16% align="center"> <a class="pilihan" href='UbahStatus.php?Id=<?php echo $data['Id']; ?>'> <i class="fas fa-check-circle"></i> Tandai Selesai</a>   </td>
      </tr>
